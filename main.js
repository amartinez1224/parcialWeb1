        ...
        for (let i = 0; i < data.length; i++) {
            ...
            let crearCarrito = () => {
                ...
                for (let ii = 0; ii < data.length; ii++) {
                    productos = data[ii]["products"]
                    for (let jj = 0; jj < productos.length; jj++) {
                        let quantity = productos[jj]["quantity"]
                        if (quantity > 0) {
                            let subT = productos[jj]["price"] * quantity
                ...
                let row = '   <div class="col-sm">' +
                    ...
                    '</div>' +
                    '<div class="col-sm">' +
                    '<button type="button" class="btn btn-success total" >Confirm order</button>' +
                    '<button type="button" class="btn btn-danger total">Cancel</button>' +
                    '</div>'
